  ...
  return (
    <div className='max-w-[1640px] mx-auto'>
        <div className='h-full relative'>
            ...
            <img src="https://images.pexels.com/photos/958546/pexels-photo-958546.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="image" className='w-full object-cover'/>
        </div>
    </div>
  )
}
