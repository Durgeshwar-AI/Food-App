  ...
  return (
    <footer className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-black overflow-hidden cursor-default">
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute bottom-20 right-20 w-40 h-40 bg-orange-500/10 rounded-full blur-3xl animate-pulse"
          style={{ animationDelay: "1s" }}
        />
        <div
          className="absolute w-48 h-48 bg-orange-500/5 rounded-full blur-2xl transition-all duration-1000 ease-out pointer-events-none"
          style={{
                ...
                <div className="flex space-x-3">
                  {socialMediaLinks.map((social, index) => (
                    ...
                    >
                      ...
                      {/* Tooltip */}
                      {hoveredSocial === index && (
                        <div className="absolute -top-10 left-1/2 transform -translate-x-1/2 bg-orange-500 text-white px-2 py-1 rounded text-xs whitespace-nowrap z-20 font-bold">
                          {social.name}
                        </div>
                      )}
                    </div>
